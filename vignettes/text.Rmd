...
wordembeddings <- rio::import("https://oscarkjell.se/text_data_examples/wordembeddings4_100.rda")
# Load corresponding numeric variables
numeric_data <- rio::import("https://oscarkjell.se/text_data_examples/sq_data_tutorial4_100.rda")
...
#wordembeddings <- wordembeddings4_100[1:2]
#ratings_data <- sq_data_tutorial4_100[5:6]
outcomes <- textTrainLists(wordembeddings[1:2], numeric_data[1:2], nrFolds_k=10)
outcomes
...
valence_prediction_model <- rio::import("https://oscarkjell.se/text_models/trained_anew1999_valence.rds")
...
psych::corr.test(numeric_data$htext_valence, numeric_data$hilstotal)
...
psych::corr.test(norm_similarity_scores_harmony, numeric_data$hilstotal)
...
# Example data that have been pre-processed with textPlotData function is called sq_data_plottingHw_HILSSSWLS_100
