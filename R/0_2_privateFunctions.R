...
# Function returning name depending on model name exist in preregistered list
registered_model_name <- function(model_name_test){
  ...
  if(is.character(model_name_test)){
    ...
    if (model_name_test[[1]] %in% c(
      ...
      "theharmonylab/implicit-motives-power-roberta-large",
      "theharmonylab/implicit-motives-achievement-roberta-large",
      "theharmonylab/implicit-motives-affiliation-roberta-large")) {

      name <- "implicit_motives"
