...
If you want to add a pre-trained model to the L-BAM library, please fill out the details in this [Google sheet](https://docs.google.com/spreadsheets/d/14PcfTwQJZCKbSh6ylOq1Qm1VT44X4RD0aR4-dt6bink/edit?gid=194707973#gid=194707973) and email us (*rtext.contact@gmail.com*) so that we can update the table online.
...
> - **Fill out the L-BAM Submission Sheet:** Complete the submission form at [r-text.org/articles/LBAM.html](https://r-text.org/articles/LBAM.html).  
...
> - **Contact:** Email a library maintainer (see contact details at [r-text.org/articles/LBAM.html](https://r-text.org/articles/LBAM.html)) using the same email address provided under `contact_details` in the metadata.  
>
