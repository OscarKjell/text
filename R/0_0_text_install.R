...
#' specify your own, such as c("torch==1.11.0", "transformers==4.19.2", "numpy", "nltk", "scikit-learn", "datasets").
...
textrpp_install <- function(conda = "auto",
  ...
  if (rpp_version[[1]] == "rpp_version_system_specific_defaults") {
    if (is_osx() | is_linux()) {
      rpp_version <- c("torch==1.11.0", "transformers==4.19.2", "numpy", "nltk", "scikit-learn", "datasets", "evaluate")
    }
    if (is_windows()) {
      rpp_version <- c("torch==1.11.0", "transformers==4.19.2", "numpy", "nltk", "scikit-learn", "datasets", "evaluate")
    }
