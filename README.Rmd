...
For those experiencing problems or want more alternatives, please see the [Extended Installation Guide](https://www.r-text.org/articles/Extended%20Installation%20Guide.html).
...
1. First install either a text-verion. (at the moment the second step only works using the development version of tet from GitHub)
