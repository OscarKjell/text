...
The ```text```-package uses natural language processing and machine learning methods to assist in examining text variables, as well as their relation to numerical variables. 
