...
#    embeddings, tokens = hgTransformerGetEmbedding("Here is some text for grabbing two layers.", layers=[0,10])
#    print(np.array(embeddings).shape)
#    print(tokens)

#    embeddings, tokens = hgTransformerGetEmbedding("Here is more text with all layers.", layers='all')
#    print(np.array(embeddings).shape)
#    print(tokens)
