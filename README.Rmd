...
[![Travis build status](https://travis-ci.com/OscarKjell/text.svg?token=9nnh6ve7nsgaP8WiCpbC&branch=master)](https://travis-ci.com/github/OscarKjell/text)
[![Codecov test coverage](https://codecov.io/gh/oscarkjell/text/branch/master/graph/badge.svg)](https://codecov.io/gh/oscarkjell/text?branch=master)
<!-- badges: end -->
...
![Point Solution](man/figures/point_end_solution.png){width=75%}

*Text* is created through a collaboration between psychology and computer science to address research needs and ensure state-of-the-art techniques. It provides powerful functions tailored to test research hypotheses in social and behavior sciences for both relatively small and large datasets.
...
References <- c("[Devline et al. 2018](https://arxiv.org/abs/1810.04805)",
                "[Liu et al. 2019](https://arxiv.org/abs/1907.11692)",
                "[Sahn et al., 2019](https://arxiv.org/abs/1910.01108)",
                "[Devline et al.2018](https://arxiv.org/abs/1810.04805)",
