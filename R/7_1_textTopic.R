...
#' @param data (data.frame) Data including one text-variable to derive topcis from (with optional numerci or categorical variables)
#' that can be used later in the pipeline for significance test topics according to these variables.
