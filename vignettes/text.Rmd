...
The ```textTtest()``` function provide a test to examine whether two sets of texts significantly differ in meaning. It produces a t-value, p-value and cohen's D effect size. Below we examine whether the harmont text and satisfaction text responses differ in meaning. 
```{r, eval = TRUE, warning=FALSE, message=FALSE}
