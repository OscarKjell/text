...
For more detailed information about word embeddings and the language models in regard to ```text``` please see [*text: An R-package for Analyzing and Visualizing Human Language Using Natural Language Processing and Deep Learning*](www.oscarkjell.se); and for more comprehensive information about the inner workings of the language models, for example see [Illustrated BERT](https://jalammar.github.io/illustrated-bert/) or the references given in Table 1.
